...
function useFonts() {
  useEffect(() => {
    ...
    l.href =
      "https://fonts.googleapis.com/css2?family=Syne:wght@600;700;800&family=Epilogue:wght@400;500;600&family=JetBrains+Mono:wght@400;500;600&display=swap";
    l.rel = "stylesheet";
  ...
  return (
    ...
    >
      ...
      <motion.circle
        ...
        animate={
          triggered ? { strokeDashoffset: offset } : { strokeDashoffset: circ }
        }
...
function SkillRow({
  ...
  return (
    <motion.div
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLElement).style.borderColor = sk.color + "55";
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: `1px solid ${hov ? sk.color + "55" : C.border}`,
        borderRadius: 16,
        padding: "18px 16px",
        cursor: "default",
        position: "relative",
        overflow: "hidden",
        boxShadow: hov
          ? `0 16px 48px ${sk.color}1A, 0 0 0 1px ${sk.color}22`
          : "none",
    ...
    >
      <motion.div
        ...
        style={{
          ...
          height: 100,
          borderRadius: "50%",
          background: `radial-gradient(circle, ${sk.color}22, transparent 70%)`,
          pointerEvents: "none",
        }}
      />
      <div
...
function CategoryPanel({
  ...
  const avg = Math.round(
    cat.items.reduce((s, i) => s + i.pct, 0) / cat.items.length,
  );
  ...
  return (
    ...
    >
      <div
        style={{
          height: 3,
          background: `linear-gradient(90deg, ${cat.accent}, ${cat.secondAccent}, transparent)`,
        }}
      />
      <div
        style={{
            ...
            <div key={s.l} style={{ textAlign: "center" }}>
              <div
                style={{
                  ...
                  fontWeight: 800,
                  fontSize: 16,
                  background: `linear-gradient(135deg, ${cat.accent}, ${cat.secondAccent})`,
...
function OverviewSidebar({
  ...
  const totalAvg = Math.round(
    allSkills.reduce((s, i) => s + i.pct, 0) / allSkills.length,
  );
          ...
          >
            ...
            <span
              style={{
                ...
                fontWeight: 800,
                fontSize: 16,
                background: `linear-gradient(135deg, ${s.accent}, ${C.cyan})`,
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}
            >
              ...
              >
                <span
                  style={{
                    ...
                    fontWeight: 500,
                    fontSize: 12,
                    color: isActive ? cat.accent : C.t3,
  ...
  return (
    ...
    >
      <div style={{ display: "flex", gap: 7, flexWrap: "wrap" }}>
        {[
          { key: "all", label: "All", accent: C.violet },
          ...CATEGORY_KEYS.map((k) => ({
            key: k,
            label: SKILLS[k].label,
            accent: SKILLS[k].accent,
          })),
        ].map((f) => {
          ...
          return (
            <motion.button
              ...
              style={{
                ...
                fontWeight: 600,
                fontSize: 13,
                color: isActive ? f.accent : C.t2,
                background: isActive ? f.accent + "14" : "transparent",
                border: `1px solid ${isActive ? f.accent + "55" : C.border}`,
                borderRadius: 999,
                padding: "8px 16px",
                cursor: "pointer",
                position: "relative",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Production-grade tools I use to build APIs, UIs, databases and cloud
          infrastructure.
        </p>
      </div>
    </motion.div>
...
export default function SkillsSection() {
  ...
  const visibleKeys =
    filter === "all"
      ? CATEGORY_KEYS
      : CATEGORY_KEYS.filter((k) => k === filter);
    ...
    >
      <div
        style={{
          ...
          width: "38%",
          height: "48%",
          background: `radial-gradient(ellipse, ${C.violet}0B 0%, transparent 70%)`,
          borderRadius: "50%",
          pointerEvents: "none",
        }}
      />
      <div
        style={{
          ...
          width: "34%",
          height: "44%",
          background: `radial-gradient(ellipse, ${C.cyan}07 0%, transparent 70%)`,
          borderRadius: "50%",
          pointerEvents: "none",
        }}
      />
