...
const SKILLS: Record<string, SkillCategory> = {
  backend: {
    ...
    items: [
      { name:"Java",       pct:90, color:"#ED8B00", tag:"Proficient", years:"1yr" },
      { name:"Springboot", pct:85, color:"#A78BFA", tag:"Familiar",   years:"1yr" },
      { name:"Node.js",    pct:96, color:"#68A063", tag:"Expert",     years:"3yr" },
      { name:"Express.js", pct:90, color:"#9F7AEA", tag:"Expert",     years:"3yr" },
      { name:"Python",     pct:94, color:"#4B8BBE", tag:"Expert",     years:"3yr" },
      { name:"Flask",      pct:82, color:"#22D3EE", tag:"Proficient", years:"2yr" },
      { name:"TypeScript", pct:90, color:"#3178C6", tag:"Proficient", years:"2yr" },
  ...
  frontend: {
    ...
    items: [
      { name:"React.js",   pct:92, color:"#61DAFB", tag:"Proficient", years:"2yr" },
      { name:"Next.js",    pct:90, color:"#AAAAFF", tag:"Proficient", years:"1yr" },
      { name:"TypeScript", pct:92, color:"#3178C6", tag:"Proficient", years:"2yr" },
      { name:"Tailwind",   pct:88, color:"#06B6D4", tag:"Proficient", years:"2yr" },
      { name:"Material UI",pct:88, color:"#0081CB", tag:"Proficient", years:"2yr" },
      { name:"HTML / CSS", pct:90, color:"#E34F26", tag:"Expert",     years:"4yr" },
      { name:"Bootstrap",  pct:88, color:"#7952B3", tag:"Proficient", years:"2yr" },
    ],
  },
  database: {
    ...
    items: [
      ...
      { name:"MS SQL Server",pct:90, color:"#CC2927", tag:"Proficient", years:"2yr" },
      { name:"MongoDB",      pct:88, color:"#4DB33D", tag:"Proficient", years:"2yr" },
  ...
  tools: {
    ...
    items: [
      { name:"Azure",       pct:97, color:"#0089D0", tag:"Proficient", years:"2yr" },
      ...
      { name:"VS Code",     pct:90, color:"#007ACC", tag:"Expert",     years:"4yr" },
      { name:"scikit-learn",pct:80, color:"#F89939", tag:"Familiar",   years:"1yr" },
    ],
  },
};
